...
public class DriveConstants {
  ...
  // Drive assist PID and tolerances
  public static final double driveAssistKp = 1.0;
  public static final double driveAssistKi = 0.0;
  public static final double driveAssistKd = 0.0;
